...
/**
 * Error boundary del segmento /resumen (contrato Next 16: error + unstable_retry).
...
export default function ResumenError({
  ...
  return (
    <div className="flex flex-col items-center text-center gap-2" style={{ padding: "48px 24px", fontFamily: "var(--font-sans)" }}>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 600, color: "var(--color-neutral-900)" }}>No se pudo cargar el resumen</h2>
