 ...
 * La query de contexto lanza aquí cuando el id no existe o es de otro tenant
 * (NOT_FOUND opaco de M2): ese caso no se reintenta — se ofrece volver a
 * Inicio. El resto sigue el patrón genérico de /actividad.
 */
export default function RegistrarInteraccionError({
  error,
  unstable_retry,
}: {
