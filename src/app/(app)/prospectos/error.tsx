 ...
 *
 * Las subrutas con boundary propio —[id] y nuevo— siguen usando el suyo, que es
 * más cercano en el árbol; este solo cubre el Pipeline.
 */
export default function ProspectosError({
  error,
  unstable_retry,
}: {
